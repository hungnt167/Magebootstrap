 ...
 * Time: 12:12 AM
 */
class Widget_Slider_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
     * Media path to extension imahes
     * @var string
     */
    const MEDIA_PATH = 'widget_slider';
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('widget_slider')->__('Uploaded image is not valid'));
            }
